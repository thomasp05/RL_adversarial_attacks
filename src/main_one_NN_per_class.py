...
for i in range(10):
    ...
    fileName = "One_NN_per_Class_Results/class_negr5_no1000/results/model_for_class{0}_{1}.pdf".format(target_label, nb_episode)
    modelName = 'One_NN_per_Class_Results/class_negr5_no1000/models/model_for_class{0}_{1}.pt'.format(target_label, nb_episode)

    # name of the textfile where the results will be saved
    textFileName = "One_NN_per_Class_Results/class_negr5_no1000/results_{0}.txt".format(nb_episode)

    # name for plots 
    reward_plot_name = "One_NN_per_Class_Results/class_negr5_no1000/plots/cumul_reward_class{0}_{1}.png".format(target_label, nb_episode)
    loss_plot_name = 'One_NN_per_Class_Results/class_negr5_no1000/plots/cumul_loss_class{0}_{1}.png'.format(target_label, nb_episode)
